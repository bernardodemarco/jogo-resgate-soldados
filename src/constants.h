...
#define HARD_AMMUNITION 7
#define MEDIUM_AMMUNITION 5
#define EASY_AMMUNITION 2

#define HARD_RELOAD_TIME 250
#define MEDIUM_RELOAD_TIME 750
#define EASY_RELOAD_TIME 1500

#define HARD_TIME_BETWEEN_SHOTS 400
#define MEDIUM_TIME_BETWEEN_SHOTS 600
#define EASY_TIME_BETWEEN_SHOTS 800